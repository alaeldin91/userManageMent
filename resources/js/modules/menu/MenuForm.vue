    ...
    <form v-on:submit.prevent="handleSubmit">
      <div class="form-group">
        ...
        <input
          ...
          v-model="food.item"
        >
        <div class="validation-message" v-text="validations.getMessage('item')">
      ...
      <div class="form-group">
        ...
        <multiselect :options="catogries" v-model="food.catogry"> </multiselect>
                <div class="validation-message" v-text="validations.getMessage('catogry')">
                </div>

      </div>
      <div class="form-group">
        <label for="price"> Price</label>
        <input class="form-controll" type="text" placeholder="Enter Price " v-model="food.price" />
                        <div class="validation-message" v-text="validations.getMessage('price')">
                        </div>
